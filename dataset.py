...
def cif2key(cif):
    """
    Only work for the cifs generated by CYANIDE (comment parsing).
    """
    node_dict = {}
    edge_dict = {}
...
class DataLoader:
    def __init__(self, topologies, node_hash, edge_hash, V):
        """
        Arguments:
            topologies: dictionary containing Topology object. Key is the name
                of topology.
            node_hash: dictionary of node_bb_name to unique index.
            edge_hash: dictionary of edge_bb_name to unique index.
            V: random embedding numpy array of size (n, m) (See self.key2data).
                Any tensors of random variables are possible.
        """
    ...
    def key2data(self, key):
        ...
        # The number of slices of cos angles [-1, 1].
        n = 20
        # The size of node type embedding vector.
        m = 32
        beta = 0.1
        ...
        max_n = topo.n_nodes
        N = np.zeros(max_n, dtype=np.int32)
